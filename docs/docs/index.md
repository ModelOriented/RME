# RME - Recurrent Memory Explainer <img src="README_files/drwhy_RME_website.png" align="right" width="150"/>
...
```
<img src="README_files/demo_profiles.png" width="500">

```{python}
e.plot_local_perturbations(type='probability_change', title = 'Demo explanation, class: positive')
```
<img src="README_files/demo_scores.png" width="500">

```{python}
e.plot_local_perturbations(type='probability_change', title = 'Demo explanation, class: positive')
```
<img src="README_files/demo_step_by_step.png" width="800">
...
<img src="README_files/demo_another_example.png" width="500">
